...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _cart_top_cart_top_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./cart-top/cart-top.component */
    "./src/app/cart-top/cart-top.component.ts");
    /* harmony import */


    var _cart_product_cart_product_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./cart-product/cart-product.component */
    "./src/app/cart-product/cart-product.component.ts");
    /* harmony import */


    var _cart_calculation_cart_calculation_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./cart-calculation/cart-calculation.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 0,
      consts: [[1, "cart_main"], [1, "cart_main_product"], [1, "cart_main_calc"]],
      ...
      directives: [_cart_top_cart_top_component__WEBPACK_IMPORTED_MODULE_1__["CartTopComponent"], _cart_product_cart_product_component__WEBPACK_IMPORTED_MODULE_2__["CartProductComponent"], _cart_calculation_cart_calculation_component__WEBPACK_IMPORTED_MODULE_3__["CartCalculationComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _cart_product_cart_product_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./cart-product/cart-product.component */
    "./src/app/cart-product/cart-product.component.ts");
    /* harmony import */


    var _cart_top_cart_top_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./cart-top/cart-top.component */
    "./src/app/cart-top/cart-top.component.ts");
    /* harmony import */


    var _cart_calculation_cart_calculation_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./cart-calculation/cart-calculation.component */
    "./src/app/cart-calculation/cart-calculation.component.ts");
    /* harmony import */


    var _cart_service_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js"); // import { HttpClient } from 'selenium-webdriver/http';
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], // HttpClient,
      _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _cart_product_cart_product_component__WEBPACK_IMPORTED_MODULE_5__["CartProductComponent"], _cart_top_cart_top_component__WEBPACK_IMPORTED_MODULE_6__["CartTopComponent"], _cart_calculation_cart_calculation_component__WEBPACK_IMPORTED_MODULE_7__["CartCalculationComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], // HttpClient,
        _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"]]
      });
    })();
  ...
  /***/
  function srcAppCartCalculationCartCalculationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CartCalculationComponent", function () {
      return CartCalculationComponent;
    });
    /* harmony import */
    ...
    var _cart_service_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../cart-service.service */
    "./src/app/cart-service.service.ts");
    /* harmony import */
    ...
    function CartCalculationComponent_tr_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CartCalculationComponent_tr_11_Template_i_click_5_listener() {
          ...
          return ctx_r6.productCountChange(product_r5, "decrement");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CartCalculationComponent_tr_11_Template_input_ngModelChange_6_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);

          var product_r5 = ctx.$implicit;
          return product_r5.count = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CartCalculationComponent_tr_11_Template_i_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);
          ...
          return ctx_r9.productCountChange(product_r5, "increment");
        });
    ...
    var CartCalculationComponent =
    /*#__PURE__*/
    function () {
      function CartCalculationComponent(cartService) {
        var _this = this;

        _classCallCheck(this, CartCalculationComponent);
        ...
        this.overallTotal = 0;
        this.cartService.callcartUpdate$.subscribe(function (isChanged) {
          if (isChanged) {
            _this.cartProducts = _this.cartService.getCartProducts();
            _this.cartProductCout = _this.cartService.getProductCount();
            var productActualPrice = 0;
            _this.productTotal = 0;
            _this.discountTotal = 0;
            _this.overallTotal = 0;

            for (var p = 0; p < _this.cartProducts.length; p++) {
              _this.productTotal += _this.cartProducts[p].price['display'];
              productActualPrice += _this.cartProducts[p].price['actual'];
              _this.discountTotal += _this.cartProducts[p].price['display'] - _this.cartProducts[p].price['actual'];
            } //this.discountTotal = this.productTotal - productActualPrice;


            _this.overallTotal = productActualPrice;
          }
        });
      }

      _createClass(CartCalculationComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "productCountChange",
        value: function productCountChange(product, type) {
          if (type == "increment") {
            product.count++;
          }
    ...
    CartCalculationComponent.ɵfac = function CartCalculationComponent_Factory(t) {
      return new (t || CartCalculationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_cart_service_service__WEBPACK_IMPORTED_MODULE_1__["CartServiceService"]));
    };

    CartCalculationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CartCalculationComponent,
      selectors: [["app-cart-calculation"]],
      decls: 44,
      vars: 5,
      consts: [[1, "cart_calc"], [1, "productCount"], [4, "ngFor", "ngForOf"], [1, "cartTotal"], [1, "price"], [1, "finalTotal"], [1, "productName"], [3, "src"], [1, "fa", "fa-minus", 3, "click"], ["type", "text", 3, "ngModel", "ngModelChange"], [1, "fa", "fa-plus", 3, "click"]],
      template: function CartCalculationComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CartCalculationComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _cart_service_service__WEBPACK_IMPORTED_MODULE_1__["CartServiceService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppCartProductCartProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function CartProductComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CartProductComponent_div_1_Template_button_click_15_listener() {
    ...
    function () {
      ...
      _createClass(CartProductComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.cartService.getProducts().subscribe(function (productJson) {
            if (productJson) {
              _this2.products = productJson["items"];
            }
          });
        }
      }, {
    ...
    CartProductComponent.ɵfac = function CartProductComponent_Factory(t) {
      return new (t || CartProductComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_cart_service_service__WEBPACK_IMPORTED_MODULE_1__["CartServiceService"]));
    };

    CartProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CartProductComponent,
      selectors: [["app-cart-product"]],
      decls: 2,
      vars: 1,
      consts: [[1, "product-widget"], ["class", "product", 4, "ngFor", "ngForOf"], [1, "product"], [1, "product_discount"], [1, "product_image"], [3, "src"], [1, "product_detail"], [1, "product_price"], [1, "display"], [1, "actual"], [1, "product_button"], [3, "click"], [1, "clear_both"]],
      template: function CartProductComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
  ...
  /***/
  function srcAppCartServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function CartServiceService(http) {
        ...
        this.cartAction = function (productInfo) {
          var cartProduct = [];
          return {
            setCartProduct: function setCartProduct(productInfo) {
              var filterProduct = cartProduct.filter(function (product) {
            ...
            getProductCount: function getProductCount() {
              ...
              for (var c = 0; c < cartProduct.length; c++) {
      ...
      _createClass(CartServiceService, [{
        ...
        key: "setProduct",
        value: function setProduct(productInfo) {
        ...
        key: "changeCart",
        value: function changeCart(value) {
    ...
    CartServiceService.ɵfac = function CartServiceService_Factory(t) {
      return new (t || CartServiceService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
  ...
  /***/
  function srcAppCartTopCartTopComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CartTopComponent", function () {
      return CartTopComponent;
    });
    /* harmony import */
    ...
    var CartTopComponent =
    /*#__PURE__*/
    function () {
      function CartTopComponent(cartService) {
        var _this3 = this;

        _classCallCheck(this, CartTopComponent);

        this.cartService = cartService;
        this.cartProductCout = 0;
        this.cartService.callcartUpdate$.subscribe(function (isChanged) {
          if (isChanged) {
            _this3.cartProductCout = _this3.cartService.getProductCount();
          }
        });
      }

      _createClass(CartTopComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    CartTopComponent.ɵfac = function CartTopComponent_Factory(t) {
      return new (t || CartTopComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_cart_service_service__WEBPACK_IMPORTED_MODULE_1__["CartServiceService"]));
    };

    CartTopComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CartTopComponent,
      selectors: [["app-cart-top"]],
      decls: 6,
      vars: 1,
      consts: [[1, "cart_top"], [1, "top_left"], [1, "top_center"], [1, "clear_both"]],
      template: function CartTopComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CartTopComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\sam\angular\addtocart\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
